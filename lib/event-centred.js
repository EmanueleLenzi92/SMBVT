...
$(document).ready(function() {
	...
	$("#lang.long").append(
		"<option selected disabled value='other'>OTHER VISUALISATIONS</option>",
...
function showModal(title, text, btnOK, callbackOK) {
...
function getEntitiesForEvent(eventURI, eventName) {
	...
	$.getJSON(queryURL, function(data) {
		...
		console.log(eventURI.replace("https://dlnarratives.eu", ""));
		...
		data.results.bindings.forEach(function(item, index) {
			...
			nodes.push({id: index, group: type, label: htmlDecode(item.entityName.value), url: uri})	
