    ...
    var t = {
            ...
            441: (t, e, i) => {
                ...
                const o = navigator.userAgent.toLowerCase(),
                    ...
                    a = -1 !== o.indexOf("webkit"),
                    r = "ActiveXObject" in window,
                    h = -1 !== o.indexOf("phantom"),
                    l = -1 !== o.search("android [23]"),
                    c = "undefined" != typeof orientation,
                    d = navigator.msPointerEnabled && navigator.msMaxTouchPoints && !window.PointerEvent,
                    p = window.PointerEvent && navigator.pointerEnabled && navigator.maxTouchPoints || d,
                    _ = r && "transition" in s.style,
                    u = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !l,
                    m = "MozPerspective" in s.style,
                    g = "OTransition" in s.style,
                    f = (window.opera, !window.L_NO_TOUCH && !h && (p || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch));
                let v = "devicePixelRatio" in window && window.devicePixelRatio > 1;
                if (!v && "matchMedia" in window) {
                    var y = window.matchMedia("(min-resolution:144dpi)");
                    v = y && y.matches
                }
                r && document.addEventListener;
                const w = -1 !== o.indexOf("chrome"),
                    b = -1 !== o.indexOf("gecko") && !a && !window.opera && !r,
                    x = (o.indexOf("android"), window.L_DISABLE_3D, c),
                    M = (c && window.opera, !!f),
                    k = function() {
                        var t = "portrait";
                ...
                class N {
                    ...
                    static setPosition(t, e) {
                        t._vco_pos = e, Browser.webkit3d ? (t.style[N.TRANSFORM] = N.getTranslateString(e), Browser.android && (t.style["-webkit-perspective"] = "1000", t.style["-webkit-backface-visibility"] = "hidden")) : (t.style.left = e.x + "px", t.style.top = e.y + "px")
                    }
                ...
                function W(t) {
                    return j = function(t) {
                        var e = i(329)(`./${t}.json`);
                        for (let t in R) e[t] ? "object" == typeof R[t] && (e[t] = Object.assign(R[t], e[t])) : e[t] = R[t];
                        return e
                    }(t)
                }
                class F {
                ...
                class V {
                    constructor(t, e, i) {
                        this._el = {
                            ...
                            map: {},
                            map_mask: {}
                        }, this._el.container = "object" == typeof t ? t : N.get(t), this._loaded = {
                            data: !1,
                            map: !1
                            ...
                            start_time: null
                        }, D(this.options, i), D(this.data, e), this._initLayout(), this._initEvents(), this._createMap(), this._initData()
                    }
                    ...
                    _onMapLoaded(t) {
                        this._loaded.map = !0, this.options.calculate_zoom && this.calculateMarkerZooms(), this.calculateMinMaxZoom(), this.options.map_mini && !M && this.createMiniMap(), this.initialMapLocation(), this.fire("loaded", this.data)
                    }
                    _onWheel(t) {
                        var e = this;
                        if (t.ctrlKey) {
                ...
                class Y {
                    constructor(t, e) {
                        this._el = {
                            ...
                            height: 600,
                            map_popup: !1
                        }, this.animator = null, D(this.options, e), D(this.data, t), this._initLayout()
                    }
                    show() {}
                    hide() {}
                    addTo(t) {
                ...
                let tt = {
                    toner: Q("toner", "png", 0, 20),
                    terrain: Q("terrain", "jpg", 4, 18),
                    watercolor: Q("watercolor", "jpg", 1, 16),
                    "trees-cabs-crime": {
                ...
                function et(t, e, i) {
                    for (var o = it(t), n = 0; n < e.length; n++) {
                        var s = [t, e[n]].join("-");
                        tt[s] = Q(s, i || o.type, o.minZoom, o.maxZoom)
                    }
                }

                function it(t) {
                    if (t in tt) return tt[t];
                    throw "No such provider (" + t + ")"
                }
                et("toner", ["hybrid", "labels", "lines", "background", "lite"]), et("toner", ["2010"]), et("toner", ["2011", "2011-lines", "2011-labels", "2011-lite"]), et("terrain", ["background"]), et("terrain", ["labels", "lines"], "png");
                class ot extends L.TileLayer {
                    constructor(t, e) {
                        super(t, e);
                        var i = it(t),
                        ...
                        e && D(n, e), L.TileLayer.prototype.initialize.call(this, o, n)
                    }
                }
                class nt extends V {
                    _createMap() {
                    ...
                    _createMiniMap() {
                        this.options.map_as_image && (this.zoom_min_max.min = 0), this.bounds_array || (this.bounds_array = this._getAllMarkersBounds(this._markers)), this._tile_layer_mini = this._createTileLayer(this.options.map_type), this._mini_map = new K(this._tile_layer_mini, {
                            width: 150,
                            height: 100,
                            position: "topleft",
                    ...
                    _createTileLayer(t, e) {
                        ...
                        switch (e && (n = e), o[0]) {
                            case "mapbox":
                                ...
                                break;
                            case "stamen":
                                i = new ot(o[1] || "toner-lite", n), this._map.getContainer().style.backgroundColor = "#FFFFFF";
                                break;
                            case "zoomify":
                                n.width = this.options.zoomify.width, n.height = this.options.zoomify.height, n.tolerance = this.options.zoomify.tolerance || .9, n.attribution = s + this.options.zoomify.attribution, i = new q(this.options.zoomify.path, n);
                                break;
                            case "osm":
                ...
                var at = {
                    addListener: function(t, e, i, o) {
                        ...
                        if (!t[s]) {
                            var a = function(e) {
                                return i.call(o || t, e || at._getEvent())
                            };
                            if (M && "dblclick" === e && this.addDoubleTapListener) this.addDoubleTapListener(t, a, n);
                                ...
                                a = function(e) {
                                    if (at._checkMouse(t, e)) return r(e)
                    ...
                    disableClickPropagation: function(t) {
                        at.addListener(t, st.START, at.stopPropagation), at.addListener(t, "click", at.stopPropagation), at.addListener(t, "dblclick", at.stopPropagation)
                    },
                    preventDefault: function(t) {
                        t.preventDefault ? t.preventDefault() : t.returnValue = !1
                    },
                    stop: function(t) {
                        at.preventDefault(t), at.stopPropagation(t)
                    },
                    getWheelDelta: function(t) {
                        var e = 0;
                        return t.wheelDelta && (e = t.wheelDelta / 120), t.detail && (e = -t.detail / 3), e
                ...
                class rt {
                    constructor(t, e, i) {
                        this._el = {
                            ...
                            coverbar: {},
                            grip: {}
                        }, this.collapsed = !1, this._el.container = "object" == typeof t ? t : N.get(t), e && (this._el.parent = e), this.options = {
                            width: 600,
                            height: 600,
                            duration: 1e3,
                            ease: Z.easeInOutQuint,
                            menubar_default_y: 0
                        }, this.animator = {}, D(this.options, i), this._initLayout(), this._initEvents()
                    }
                    show(t) {
                    ...
                    _onButtonCollapseMap(t) {
                        ...
                        }), this._el.button_collapse_toggle.innerHTML = x ? "<span class='vco-icon-arrow-up'></span>" : j.buttons.collapse_toggle + "<span class='vco-icon-arrow-up'></span>") : (this.collapsed = !0, this.hide(25), this._el.button_overview.style.display = "none", this.fire("collapse", {
                            y: 1
                        }), this._el.button_collapse_toggle.innerHTML = x ? "<span class='vco-icon-arrow-down'></span>" : j.buttons.uncollapse_toggle + "<span class='vco-icon-arrow-down'></span>")
                    }
                    _initLayout() {
                        this._el.button_overview = N.create("span", "vco-menubar-button", this._el.container), at.addListener(this._el.button_overview, "click", this._onButtonOverview, this), this._el.button_backtostart = N.create("span", "vco-menubar-button", this._el.container), at.addListener(this._el.button_backtostart, "click", this._onButtonBackToStart, this), this._el.button_collapse_toggle = N.create("span", "vco-menubar-button", this._el.container), at.addListener(this._el.button_collapse_toggle, "click", this._onButtonCollapseMap, this), this.options.map_as_image ? this._el.button_overview.innerHTML = j.buttons.overview : this._el.button_overview.innerHTML = j.buttons.map_overview, x ? (this._el.button_backtostart.innerHTML = "<span class='vco-icon-goback'></span>", this._el.button_collapse_toggle.innerHTML = "<span class='vco-icon-arrow-up'></span>", this._el.container.setAttribute("ontouchstart", " ")) : (this._el.button_backtostart.innerHTML = j.buttons.backtostart + " <span class='vco-icon-goback'></span>", this._el.button_collapse_toggle.innerHTML = j.buttons.collapse_toggle + "<span class='vco-icon-arrow-up'></span>"), "landscape" == this.options.layout && (this._el.button_collapse_toggle.style.display = "none")
                    }
                    _initEvents() {}
                    _updateDisplay(t, e, i) {
                ...
                class ct {
                    constructor(t, e, i) {
                        this._el = {
                            ...
                            direction: "previous"
                        }, this.animator = null, this.animator_position = null, D(this.options, e), D(this.data, t), this._el.container = N.create("div", "vco-slidenav-" + this.options.direction), x && this._el.container.setAttribute("ontouchstart", " "), this._initLayout(), this._initEvents(), i && i.appendChild(this._el.container)
                    }
                    update(t) {
                        this._update(t)
                    }
                    ...
                    updatePosition(t, e, i, o, n, s) {
                        ...
                        this.animator_position && this.animator_position.stop(), a = h.right ? "right" : "left", this._el.container.style[a] = e ? l + "%" : l + "px", this.animator_position = ht(this._el.container, h)
                    }
                    ...
                    _update(t) {
                        this.data = D(this.data, t), "" != this.data.title && (this._el.title.innerHTML = this.data.title), "" != this.data.date && (this._el.description.innerHTML = this.data.description)
                    }
                    _initLayout() {
                        this._el.content_container = N.create("div", "vco-slidenav-content-container", this._el.container), this._el.icon = N.create("div", "vco-slidenav-icon", this._el.content_container), this._el.title = N.create("div", "vco-slidenav-title", this._el.content_container), this._el.description = N.create("div", "vco-slidenav-description", this._el.content_container), this._el.icon.innerHTML = "&nbsp;", this._update()
                    }
                    _initEvents() {
                        at.addListener(this._el.container, "click", this._onMouseClick, this)
                    }
                }
                T(ct, F, H);
                class dt {
                    constructor(t, e, i) {
                        ...
                        }, D(this.data, t), D(this.options, e), this._el.container = N.create("div", this.options.message_class), i && (i.appendChild(this._el.container), this._el.parent = i), this.animator = {}, this._initLayout(), this._initEvents()
                    }
                    updateMessage(t) {
                ...
                class pt {
                    constructor(t, e, i) {
                        this._el = {
                            ...
                            credit_height: 0,
                            caption_height: 0
                        }, this.animator = {}, D(this.options, e), D(this.data, t), this._el.container = N.create("div", "vco-media"), this.data.uniqueid && (this._el.container.id = this.data.uniqueid), this._initLayout(), i && (i.appendChild(this._el.container), this._el.parent = i)
                    }
                    loadMedia() {
                        var t = this;
                    ...
                    updateMediaDisplay(t) {
                        this._state.loaded && (this._updateMediaDisplay(t), x || "portrait" == t || (this._el.content_item.style.maxHeight = this.options.height / 2 + "px"), this._state.media_loaded && (this._el.credit && (this._el.credit.style.width = "auto"), this._el.caption && (this._el.caption.style.width = "auto")), b && (this._el.content_item.offsetWidth > this._el.content_item.offsetHeight && (this._el.content_item.style.width = "100%", this._el.content_item.style.maxWidth = "100%"), "portrait" == t && (this._el.content_item.style.maxHeight = "none")), this._state.media_loaded && (this._el.credit && (this._el.credit.style.width = this._el.content_item.offsetWidth + "px"), this._el.caption && (this._el.caption.style.width = this._el.content_item.offsetWidth + "px")))
                    }
                    _loadMedia() {}
                    ...
                    loadErrorDisplay(t) {
                        this._el.content.removeChild(this._el.content_item), this._el.content_item = N.create("div", "vco-media-item vco-media-loaderror", this._el.content), this._el.content_item.innerHTML = "<div class='vco-icon-" + this.options.media_type + "'></div><p>" + t + "</p>", this.onLoaded(!0)
                    }
                    onLoaded(t) {
                    ...
                    _initLayout() {
                        this.message = new dt({}, this.options), this.message.addTo(this._el.container), this._el.content_container = N.create("div", "vco-media-content-container", this._el.container), this.data.link && "" != this.data.link ? (this._el.link = N.create("a", "vco-media-link", this._el.content_container), this._el.link.href = this.data.link, this.data.link_target && "" != this.data.link_target ? this._el.link.target = this.data.link_target : this._el.link.target = "_blank", this._el.content = N.create("div", "vco-media-content", this._el.link)) : this._el.content = N.create("div", "vco-media-content", this._el.content_container)
                    }
                    _updateDisplay(t, e, i) {
                ...
                class _t extends pt {
                    ...
                    _updateMediaDisplay(t) {
                        b && (this._el.content_item.style.width = "auto")
                    }
                }
                class ut extends pt {
                    _loadMedia() {
                        var t, e = this;
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this.youtube_loaded = !1, this._el.content_item = N.create("div", "vco-media-item vco-media-youtube vco-media-shadow", this._el.content), this._el.content_item.id = C(7), t = function(t) {
                            var e, i, o, n = [];
                ...
                class mt extends pt {
                    _loadMedia() {
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("div", "vco-media-item vco-media-blockquote", this._el.content), this.media_id = this.data.url, this._el.content_item.innerHTML = this.media_id, this.onLoaded()
                    }
                    updateMediaDisplay() {}
                    _updateMediaDisplay() {}
                }
                class gt extends pt {
                    _loadMedia() {
                        var t, e, i = this;
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("div", "vco-media-item vco-media-wikipedia", this._el.content), this.media_id = this.data.url.split("wiki/")[1].split("#")[0].replace("_", " "), this.media_id = this.media_id.replace(" ", "%20"), e = this.data.url.split("//")[1].split(".wikipedia")[0];
                    ...
                    createMedia(t) {
                        ...
                        if (t.query) {
                            ...
                            i = "<h4><a href='" + this.data.url + "' target='_blank'>" + e.title + "</a></h4>", i += "<span class='wiki-source'>" + j.messages.wikipedia + "</span>", i += e.text, e.extract.match("REDIRECT") || (this._el.content_item.innerHTML = i, this.onLoaded())
                        }
                    }
                    updateMediaDisplay() {}
                    _updateMediaDisplay() {}
                ...
                class ft extends pt {
                    _loadMedia() {
                        var t, e = this;
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("div", "vco-media-item vco-media-iframe vco-media-soundcloud vco-media-shadow", this._el.content), this.media_id = this.data.url, t = "https://soundcloud.com/oembed?url=" + this.media_id + "&format=json", fetch(t).then((t => t.json().then((t => {
                ...
                class yt extends pt {
                    _loadMedia() {
                        var t;
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("div", "vco-media-item vco-media-iframe vco-media-dailymotion", this._el.content), this.data.url.match("video") ? this.media_id = this.data.url.split("video/")[1].split(/[?&]/)[0] : this.media_id = this.data.url.split("embed/")[1].split(/[?&]/)[0], t = "https://www.dailymotion.com/embed/video/" + this.media_id + "?api=postMessage", this._el.content_item.innerHTML = "<iframe autostart='false' frameborder='0' width='100%' height='100%' src='" + t + "'></iframe>", this.onLoaded()
                    }
                    _updateMediaDisplay() {
                        this._el.content_item.style.height = z({
                            w: this._el.content_item.offsetWidth
                ...
                class bt extends pt {
                    _loadMedia() {
                        var t, e = this;
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("div", "vco-media-twitter", this._el.content);
                ...
                class Lt extends pt {
                    _loadMedia() {
                        var t, e = this;
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("img", "vco-media-item vco-media-image vco-media-flickr vco-media-shadow", this._el.content), this._el.content_item.addEventListener("load", (function(t) {
                            e.onMediaLoaded()
                ...
                class xt extends pt {
                    _loadMedia() {
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("div", "vco-media-item vco-media-iframe", this._el.content), this.media_id = this.data.url, this.media_id, this.media_id.match(/docs.google.com/i) ? this._el.content_item.innerHTML = "<iframe class='doc' frameborder='0' width='100%' height='100%' src='" + this.media_id + "&amp;embedded=true'></iframe>" : this._el.content_item.innerHTML = "<iframe class='doc' frameborder='0' width='100%' height='100%' src='http://docs.google.com/viewer?url=" + this.media_id + "&amp;embedded=true'></iframe>", this.onLoaded()
                    }
                    _updateMediaDisplay() {
                ...
                class Mt extends pt {
                    _loadMedia() {
                        this._el.content_item = N.create("img", "vco-media-item vco-media-image", this._el.content), this._el.content_item.src = this.data.url, this.onLoaded()
                    }
                }
                class kt extends pt {
                    _loadMedia() {
                        self = this, this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("div", "vco-media-item vco-media-iframe", this._el.content), this.media_id = this.data.url;
                        let t = this.media_id;
                ...
                class Pt extends pt {
                    _loadMedia() {
                        this.message.updateMessage(j.messages.loading + " " + this.options.media_name), this._el.content_item = N.create("div", "vco-media-item vco-media-iframe", this._el.content), this.media_id = this.data.url;
                ...
                class Dt {
                    constructor(t, e, i) {
                        this._el = {
                            ...
                            function(t, e) {
                                t.data = P({}, t.data, e), "" === t.data.uniqueid && (t.data.uniqueid = C(6))
                            }(this, t), D(this.options, e), this._el.container = N.create("div", "vco-text"), this._el.container.id = this.data.uniqueid, this._initLayout(), i && i.appendChild(this._el.container)
                    }
                    show() {}
                    hide() {}
                    addTo(t) {
                    ...
                    _initLayout() {
                        ...
                        if ("" != this.data.text) {
                            var e = "";
                            e += E(this.data.text), this.data.date && this.data.date.created_time && "" != this.data.date.created_time && this.data.date.created_time.length > 10 && ("undefined" != typeof moment ? e += "<div class='vco-text-date'>" + moment(this.data.date.created_time, "YYYY-MM-DD h:mm:ss").fromNow() + "</div>" : e += "<div class='vco-text-date'>" + function(t) {
                            ...
                            }(this.data.date.created_time) + "</div>"), this._el.content = N.create("div", "vco-text-content", this._el.content_container), this._el.content.innerHTML = e
                        }
                        this.onLoaded()
                    }
                }
                ...
                class St {
                    ...
                    show() {
                        this.animator = ht(this._el.slider_container, {
                    ...
                    addCallToAction(t) {
                        this._el.call_to_action = N.create("div", "vco-slide-calltoaction", this._el.content_container), this._el.call_to_action.innerHTML = "<span class='vco-slide-calltoaction-button-text'>" + t + "</span>", at.addListener(this._el.call_to_action, "click", this._onCallToAction, this)
                    }
                    _onCallToAction(t) {
                        this.fire("call_to_action", t)
                    }
                    _initLayout() {
                        this._el.container = N.create("div", "vco-slide"), this.data.uniqueid && (this._el.container.id = this.data.uniqueid), this._el.scroll_container = N.create("div", "vco-slide-scrollable-container", this._el.container), this._el.content_container = N.create("div", "vco-slide-content-container", this._el.scroll_container), this._el.content = N.create("div", "vco-slide-content", this._el.content_container), this._el.background = N.create("div", "vco-slide-background", this._el.container), this.data.background && (this.data.background.url && (this.has.background.image = !0, this._el.container.className += " vco-full-image-background", this.has.background.color_value = "#000", this._el.background.style.backgroundImage = "url('" + this.data.background.url + "')", this._el.background.style.display = "block"), this.data.background.color && (this.has.background.color = !0, this._el.container.className += " vco-full-color-background", this.has.background.color_value = this.data.background.color), this.data.background.text_background && (this._el.container.className += " vco-text-background")), this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0), this.data.text && this.data.text.text && (this.has.text = !0), this.data.text && this.data.text.headline && (this.has.headline = !0, this.title = this.data.text.headline), this.has.media && (this.data.media.mediatype = Tt(this.data.media), this.options.media_name = this.data.media.mediatype.name, this.options.media_type = this.data.media.mediatype.type, this._media = new this.data.media.mediatype.cls(this.data.media, this.options)), (this.has.text || this.has.headline) && (this._text = new Dt(this.data.text, {
                ...
                class Ct {
                    constructor(t, e, i) {
                        this.mousedrag = {
                            ...
                            duration: 1e3,
                            ease: Z.easeInOutQuint
                        }, this.animator = null, this.dragevent = this.mousedrag, M && (this.dragevent = this.touchdrag), this.data = {
                            sliding: !1,
                            direction: "none",
                            pagex: {
                                start: 0,
                    ...
                    enable(t) {
                        at.addListener(this._el.drag, this.dragevent.down, this._onDragStart, this), at.addListener(this._el.drag, this.dragevent.up, this._onDragEnd, this), this.data.pos.start = 0, this._el.move.style.left = this.data.pos.start.x + "px", this._el.move.style.top = this.data.pos.start.y + "px", this._el.move.style.position = "absolute"
                    }
                    disable() {
                        at.removeListener(this._el.drag, this.dragevent.down, this._onDragStart, this), at.removeListener(this._el.drag, this.dragevent.up, this._onDragEnd, this)
                    }
                    stopMomentum() {
                        this.animator && this.animator.stop()
                    }
                    ...
                    _onDragStart(t) {
                        this.animator && this.animator.stop(), M ? t.originalEvent ? (this.data.pagex.start = t.originalEvent.touches[0].screenX, this.data.pagey.start = t.originalEvent.touches[0].screenY) : (this.data.pagex.start = t.targetTouches[0].screenX, this.data.pagey.start = t.targetTouches[0].screenY) : (this.data.pagex.start = t.pageX, this.data.pagey.start = t.pageY), this.options.enable.x, this.options.enable.y, this.data.pos.start = {
                            x: this._el.move.offsetLeft,
                            y: this._el.move.offsetTop
                        }, this.data.time.start = (new Date).getTime(), this.fire("dragstart", this.data), at.addListener(this._el.drag, this.dragevent.move, this._onDragMove, this), at.addListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this)
                    }
                    _onDragEnd(t) {
                        this.data.sliding = !1, at.removeListener(this._el.drag, this.dragevent.move, this._onDragMove, this), at.removeListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this), this.fire("dragend", this.data), this._momentum()
                    }
                    _onDragMove(t) {
                        var e = {
                            x: 0,
                        ...
                        this.data.sliding = !0, M ? t.originalEvent ? (this.data.pagex.end = t.originalEvent.touches[0].screenX, this.data.pagey.end = t.originalEvent.touches[0].screenY) : (this.data.pagex.end = t.targetTouches[0].screenX, this.data.pagey.end = t.targetTouches[0].screenY) : (this.data.pagex.end = t.pageX, this.data.pagey.end = t.pageY), e.x = this.data.pagex.start - this.data.pagex.end, e.y = this.data.pagey.start - this.data.pagey.end, this.data.pos.end = {
                    ...
                    _animateMomentum() {
                        ...
                        this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)), e.top = Math.floor(t.y) + "px"), this.options.enable.x && ((this.options.constraint.left || this.options.constraint.right) && (t.x >= this.options.constraint.left ? t.x = this.options.constraint.left : t.x < this.options.constraint.right && (t.x = this.options.constraint.right)), e.left = Math.floor(t.x) + "px"), this.animator = ht(this._el.move, e), this.fire("momentum", this.data)
                    }
                }
                T(Ct, F);
                class Et {
                    constructor(t, e, i, o) {
                        this._el = {
                            ...
                            dragging: !0,
                            trackResize: !0
                        }, "object" == typeof t ? (this._el.container = t, this.options.id = C(6, "vco")) : (this.options.id = t, this._el.container = N.get(t)), this._el.container.id || (this._el.container.id = this.options.id), this.animator = null, this.animator_background = null, D(this.options, i), D(this.data, e), o && this.init()
                    }
                    init() {
                    ...
                    _createSlides(t) {
                        for (var e = 0; e < t.length; e++) "" == t[e].uniqueid && (t[e].uniqueid = C(6, "vco-slide")), 0 == e ? this._createSlide(t[e], !0) : this._createSlide(t[e], !1)
                    }
                    _createSlide(t, e) {
                        var i = new St(t, this.options, e);
                    ...
                    goTo(t, e, i) {
                        ...
                        t < this._slides.length && t >= 0 && (this.current_slide = t, this.animator && this.animator.stop(), this._swipable && this._swipable.stopMomentum(), e ? (this._el.slider_container.style.left = -this.slide_spacing * t + "px", this._onSlideChange(i)) : this.animator = ht(this._el.slider_container, {
                    ...
                    showNav(t, e) {
                        this.options.width <= 500 && x || (e ? t.show() : t.hide())
                    }
                    changeBackground(t) {
                        var e, i = this,
                            o = !1,
                    ...
                    fadeInBackground(t) {
                        this.animator_background && this.animator_background.stop(), t && this._el.background.setAttribute("style", t), this.animator_background = ht(this._el.background, {
                            opacity: 1,
                            duration: this.options.duration / 2,
                            easing: this.options.ease
                        })
                    ...
                    _initLayout() {
                        this._el.container.className += " vco-storyslider", this._el.slider_container_mask = N.create("div", "vco-slider-container-mask", this._el.container), this._el.background = N.create("div", "vco-slider-background", this._el.container), this._el.slider_container = N.create("div", "vco-slider-container vcoanimate", this._el.slider_container_mask), this._el.slider_item_container = N.create("div", "vco-slider-item-container", this._el.slider_container), this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this._nav.previous = new ct({
                            title: "Previous",
                            description: "description"
                        }, {
                            direction: "previous"
                        }), this._nav.next = new ct({
                            title: "Next",
                            description: "description"
                        }, {
                            direction: "next"
                        }), this._nav.next.addTo(this._el.container), this._nav.previous.addTo(this._el.container), this._el.slider_container.style.left = "0px", M && (this._swipable = new Ct(this._el.slider_container_mask, this._el.slider_container, {
                            enable: {
                                x: !0,
                                y: !1
                            },
                            snap: !0
                        }), this._swipable.enable(), this._message = new dt({}, {
                            message_class: "vco-message-full",
                            message_icon_class: "vco-icon-swipe-left"
                        }), this._message.updateMessage(j.buttons.swipe_to_navigate), this._message.addTo(this._el.container))
                    }
                    _initEvents() {
                    ...
                    _fireMouseEvent(t) {
                        if (this._loaded) {
                            var e = t.type;
                            e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e, this.hasEventListeners(e) && ("contextmenu" === e && at.preventDefault(t), this.fire(e, {
                                latlng: "something",
                ...
                class Ot {
                    constructor(t, e, i, o) {
                        ...
                        return this.version = "0.1.16", this.ready = !1, this._el = {
                            ...
                            map: {},
                            menubar: {}
                        }, this._el.container = "object" == typeof t ? t : N.get(t), this._storyslider = {}, this._map = {}, this.map = {}, this._menubar = {}, this._loaded = {
                            storyslider: !1,
                            map: !1
                            ...
                            api_key_flickr: "8f2d5becf7b6ba46570741620054b507",
                            language: "en"
                        }, this.current_slide = this.options.start_at_slide, this.animator_map = null, this.animator_storyslider = null, D(this.options, i), this._initData(e), this
                    }
                    _initData(t) {
                        var e = this;
                    ...
                    _initOptions() {
                        ...
                        ! function(t, e) {
                            ...
                            left: -200,
                            top: 0
                        }), "zoomify" == this.options.map_type && this.options.map_as_image && (this.options.map_size_sticky = 2), this.options.map_as_image && (this.options.calculate_zoom = !1), this.options.relative_date ? "undefined" != typeof moment ? t._loadLanguage() : B(this.options.script_path + "/library/moment.js", (function() {
                            t._loadLanguage()
                        })) : t._loadLanguage(), w && A(function(t, e) {
                            ...
                            for (var i = t.split("/"), o = e.split("/"), n = [], s = 0, a = i.length; s < a; s++)
								...
								alert(this.options.script_path)
                        }("", ""), (function() {}))
                    }
                    _loadLanguage() {
                        W(this.options.language), this._onDataLoaded()
                    }
                    goTo(t) {
                    ...
                    _initLayout() {
                        this._el.container.className += " vco-storymap", this.options.base_class = this._el.container.className, this._el.menubar = N.create("div", "vco-menubar", this._el.container), this._el.map = N.create("div", "vco-map", this._el.container), this._el.storyslider = N.create("div", "vco-storyslider", this._el.container), this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this._el.map.style.height = "1px", this._el.storyslider.style.top = "1px", this._map = new nt(this._el.map, this.data, this.options), this.map = this._map._map, this._map.on("loaded", this._onMapLoaded, this), this._el.map.style.backgroundColor = this.options.map_background_color, this._menubar = new rt(this._el.menubar, this._el.container, this.options), this._storyslider = new Et(this._el.storyslider, this.data, this.options), this._storyslider.on("loaded", this._onStorySliderLoaded, this), this._storyslider.on("title", this._onTitle, this), this._storyslider.init(), "portrait" == this.options.layout ? (this.options.map_height = this.options.height / this.options.map_size_sticky, this.options.storyslider_height = this.options.height - this._el.menubar.offsetHeight - this.options.map_height - 1, this._menubar.setSticky(0)) : (this.options.menubar_height = this._el.menubar.offsetHeight, this.options.map_height = this.options.height, this.options.storyslider_height = this.options.height - this._el.menubar.offsetHeight - 1, this._menubar.setSticky(this.options.menubar_height)), this._updateDisplay(this.options.map_height, !0, 2e3), this._menubar.show(2e3)
                    }
                    _initEvents() {
                    ...
                    _updateDisplay(t, e, i) {
                        var o = this.options.duration,
                            ...
                            s = this;
                        i && (o = i), this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this.options.width <= this.options.skinny_size ? this.options.layout = "portrait" : this.options.layout = "landscape", t && (this.options.map_height = t), M && (this.options.layout = k(), n += " vco-mobile"), "portrait" == this.options.layout ? (n += " vco-skinny", this._map.setMapOffset(0, 0), this.options.map_height = this.options.height / this.options.map_size_sticky, this.options.storyslider_height = this.options.height - this.options.map_height - 1, this._menubar.setSticky(0), n += " vco-layout-portrait", e ? (this.animator_map && this.animator_map.stop(), this.animator_map = ht(this._el.map, {
                        ...
                        }), this.animator_storyslider && this.animator_storyslider.stop(), this.animator_storyslider = ht(this._el.storyslider, {
                ...
                T(Ot, F), i(16), window.trace = function(t) {
                    console.log(t)
                };
                const zt = {
                    Load: {
